return {
  {
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        javascriptreact = { "biome", "eslint", "eslint_d" },
        typescriptreact = { "biome", "eslint", "eslint_d" },
        astro = { "prettierd", "prettier", "biome", "eslint", "eslint_d", "stylelint" },
        vue = { "prettierd", "prettier", "biome", "eslint", "eslint_d" },
  ...
  },
  {
    ...
    opts = {
      ...
      linters_by_ft = {
        ...
        astro = { "biomejs", "eslint", "eslint_d", "stylelint" },
